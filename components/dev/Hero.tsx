      ...
      <div className="wrap">
        <div className="hero-minimal">
          <h1 className="hero-headline display">
            Reserved desks for{' '}
            <span className="hl-accent">computer&nbsp;professionals</span> in Bhilwara.
          </h1>
          <p className="hero-sub">
            ₹3,000/month. 32 seats, 13 vetted neighbors, gigabit cable, an 8-hour UPS,
            hot RO water, and <strong>zero</strong> open-floor sales calls.{' '}
            <strong>That&apos;s the whole pitch.</strong>
          </p>
          <div className="hero-ctas">
            ...
            <a className="dev-btn" href="#facilities">scroll the floor</a>
          </div>
